...
urlpatterns = [
    ...
    path('auth/login/', views.auth_login_api_view, name='auth_login_api'),
    path('auth/logout/', views.auth_logout_api_view, name='auth_logout_api'),
    path('auth/session/', views.auth_session_view, name='auth_session'),
    # Platform super-admin (cross-tenant, is_superuser only)
    path('admin/tenants/', views.admin_tenants_view, name='admin_tenants'),
    path('admin/tenants/<str:tenant_id>/', views.admin_tenant_detail_view, name='admin_tenant_detail'),
    ...
    path('admin/memberships/<str:membership_id>/', views.admin_membership_detail_view, name='admin_membership_detail'),
    path('admin/permissions/catalog/', views.admin_permissions_catalog_view, name='admin_permissions_catalog'),
    path('admin/audit/', views.admin_audit_view, name='admin_audit'),
    ...
    path('alerts/close/', views.alerts_close_view, name='alerts_close'),
    ...
    path('fleet/targets/<str:target_id>/config/', views.fleet_target_config_view, name='fleet_target_config'),
    path('fleet/targets/<str:target_id>/config/apply/', views.fleet_target_config_apply_view, name='fleet_target_config_apply'),
    path('fleet/profiles/', views.fleet_profiles_view, name='fleet_profiles'),
    path('fleet/policy-profiles/', views.fleet_policy_profiles_view, name='fleet_policy_profiles'),
    ...
    path('fleet/targets/<str:target_id>/agent/poll/', views.fleet_cluster_agent_poll_view, name='fleet_cluster_agent_poll'),
    path('fleet/targets/<str:target_id>/agent/result/', views.fleet_cluster_agent_result_view, name='fleet_cluster_agent_result'),
